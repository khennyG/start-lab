...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const linksBase: { label: string; href: string; icon: React.ReactNode; badge?: string }[] = [
    ...
    { label: "Artifacts", href: "/explore/artifacts", icon: <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5z" /><path d="M2 17l10 5 10-5" /><path d="M2 12l10 5 10-5" /></svg> },
